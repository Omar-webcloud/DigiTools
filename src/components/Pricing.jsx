    ...
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-stretch max-w-6xl mx-auto">
        <div className="glass-card p-12 rounded-[2.5rem] flex flex-col border-white/5 shadow-2xl">
          ...
          <button className="h-16 w-full border border-white/10 text-[#F4E1D2]/60 hover:text-[#F4E1D2] hover:bg-white/5 rounded-xl font-semibold text-[10px] uppercase tracking-[0.3em] transition-all">Initialize</button>
        </div>
        ...
        <div className="relative group lg:scale-110 z-10">
          ...
          <div className="glass-card bg-[#1A1614]/95 p-12 rounded-[2.5rem] h-full flex flex-col border-[#BF7D3A]/30 relative overflow-hidden shadow-3xl">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#BF7D3A] text-[#1A1614] px-8 py-2 rounded-b-xl text-[9px] font-bold tracking-[0.3em] uppercase shadow-2xl">
               Prestige
            </div>
            <div className="mb-14 mt-6">
              <h3 className="text-3xl font-medium text-[#F4E1D2] mb-3 tracking-tight font-serif italic">Professional</h3>
              <p className="text-[#BF7D3A] font-semibold text-[10px] uppercase tracking-[0.3em]">High-Velocity Node</p>
            </div>
            <div className="mb-14 flex items-baseline gap-2">
              <span className="text-7xl font-light text-[#F4E1D2] tracking-tighter text-glow-amber font-serif italic">$29</span>
              <span className="text-[#F4E1D2]/40 font-medium text-xs uppercase tracking-[0.2em]">/mo</span>
            </div>
            <div className="space-y-6 mb-16 grow">
              {['Unlimited Synthesis', 'Priority Matrix', 'Private Archives', '24/7 Identity Support', 'Global Sync', 'Advanced Uplink'].map((f, i) => (
                <div key={i} className="flex items-center gap-5 text-[11px] text-[#F4E1D2]/80 font-semibold uppercase tracking-[0.2em]">
                   <div className="w-5 h-5 rounded-full bg-[#BF7D3A] flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(191,125,58,0.4)]">
                      <FaCheck className="w-2 h-2 text-[#1A1614]" />
                   </div>
                  {f}
                </div>
              ))}
            </div>
            <button className="btn-amber h-20 w-full text-[10px]">Synchronize</button>
          </div>
        </div>

        <div className="glass-card p-12 rounded-[2.5rem] flex flex-col border-white/5 shadow-2xl">
          <div className="mb-14">
             <h3 className="text-2xl font-medium text-[#F4E1D2] mb-3 tracking-tight font-serif italic">Enterprise</h3>
             <p className="text-[#F4E1D2]/30 font-semibold text-[10px] uppercase tracking-[0.3em]">Global Matrix</p>
          </div>
          <div className="mb-14 flex items-baseline gap-2">
          ...
          <button className="h-16 w-full border border-white/10 text-[#F4E1D2]/60 hover:text-[#F4E1D2] hover:bg-white/5 rounded-xl font-semibold text-[10px] uppercase tracking-[0.3em] transition-all">Connect</button>
        </div>
      </div>
    </div>
  </section>
